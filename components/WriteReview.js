...
const WriteReview = () => {
  return (
    <div className="text-black p-4 md:flex md:flex-row  md:justify-center  flex-col items-center justify-center  gap-5">
      {/* Div to upload files by clicking here  */}
      <div className="bg-gray-300 md:w-[30vw] w-[80vw] h-[300px] flex justify-center items-center rounded-3xl mb-6">
        <img src="/uploadFile.png" alt="Upload" />
      </div>

      {/* Div to Handle Form Data */}
      <div className="space-y-4 md:w-[50%] w-[90%]">
        {/* Div to take Title Input  */}
        <div>
          <label htmlFor="summary" className="block font-semibold mb-1">
            Summarize your Travel Journey
          </label>
          <input
            type="text"
            id="summary"
