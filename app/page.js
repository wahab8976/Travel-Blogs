...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      <Navbar /> {/* Set visibility here */}
      <div className="flex flex-grow flex-col">
        <div className="flex flex-grow justify-center relative z-10">
          <section className="w-1/3 bg-red-600 flex-grow h-[90vh] flex items-end">
            <div className="text-normal p-5 text-white">
          ...
          <section className="w-1/3 bg-green-600 flex-grow h-[90vh] flex items-end">
            <div className="text-normal p-5 text-white">
              <h2>Why you should</h2>
              <h2>reconsider The</h2>
              <span className="flex items-center">
          ...
          <section className="w-1/3 bg-blue-600 flex-grow h-[90vh] flex items-end">
            <div className="text-normal p-5 text-white">
              <h2>Why you should</h2>
              <h2>reconsider The</h2>
              <span className="flex items-center">
      ...
      <span className="absolute inset-0 flex items-center justify-center z-20 text-center text-white text-4xl pointer-events-none">
        <div>
